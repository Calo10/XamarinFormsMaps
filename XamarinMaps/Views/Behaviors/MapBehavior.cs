...
namespace XamarinMaps.Behaviors
{
    public class MapBehavior : BindableBehavior<Map>
    {
        ...
        public static readonly BindableProperty ItemsSourceProperty =
            BindableProperty.CreateAttached("ItemsSource", typeof(IEnumerable<Location>), typeof(MapBehavior),
                                            default(IEnumerable<Location>), BindingMode.Default, null, OnItemsSourceChanged);

        public IEnumerable<Location> ItemsSource
        {
            get { return (IEnumerable<Location>)GetValue(ItemsSourceProperty); }
